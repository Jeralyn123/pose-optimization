...
def create_CNN(num_action):
    ...
    h_conv5 = tf.compat.v1.nn.relu(conv2d(h_conv4, W_conv5, 1) + b_conv5)
    h_conv5_flat = tf.compat.v1.layers.flatten(h_conv5)

    h_fc1 = tf.compat.v1.nn.relu(tf.matmul(h_conv5_flat, W_fc1) + b_fc1)
